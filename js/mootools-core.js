...
(function() {
    ...
    Object.extend({
        merge: function(B, x, w) {
            ...
            for (var A = 1, u = arguments.length;
            A < u; A++) {
                var y = arguments[A];
                for (var z in y) {
                    a(B, z, y[z]);
    ...
    var m = this.Native = function(i) {
        return new k(i.name, i.initialize);
    };
    m.type = k.type;
    m.implement = function(w, u) {
    ...
    Array.type = function(i) {
        return t(i, Array) || l(i);
    };
    this.$A = function(i) {
        return Array.from(i).slice();
    };
    this.$arguments = function(u) {
        return function() {
            return arguments[u];
        };
    };
    ...
    this.$each = function(v, u, w) {
        var i = e(v);
        ((i == "arguments" || i == "collection" || i == "array" || i == "elements") ? Array : Object).each(v, u, w);
    };
    this.$empty = function() {};
    this.$extend = function(u, i) {
        return Object.append(u, i);
    };
    this.$H = function(i) {
        return new g(i);
    };
    ...
    var a = {
        " ": function(l, r, c, m, n, p, k) {
            ...
            if (this.isHTMLDocument) {
                ...
                getByClass:
                if (m && l.getElementsByClassName && !this.brokenGEBCN) {
...
(function() {
    ...
    b.inside = b.bottom;
    Object.each(b, function(p, q) {
        q = q.capitalize();
        var o = {};
        o["inject" + q] = function(r) {
            p(this, document.id(r, true));
            return this;
        };
        o["grab" + q] = function(r) {
            p(document.id(r, true), this);
            return this;
        };
        Element.implement(o);
    });
    ...
    Element.implement("hasChild", function(o) {
        return this !== o && this.contains(o);
    });
...
(function() {
    ...
    Element.Properties.opacity = {
        ...
        get: (e) ? function() {
            ...
            var f,
                g = (this.style.filter || this.getComputedStyle("filter"));
            if (g) {
                f = g.match(d);
            }
